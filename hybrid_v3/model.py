    ...
    def extract_features(
        ...
        with torch.no_grad():
            ...
            if feature_type == 'visual':
                ...
                if use_query_encoder:
                    feat, _ = self.topo_extractor_q(feat)  # type: ignore[union-attr]
                else:
                    feat, _ = self.topo_extractor_k(feat)  # type: ignore[union-attr]
                ...
                if not self.use_topology:
                    ...
                    topo_feat, _ = self.topo_extractor_q(feat) if use_query_encoder else self.topo_extractor_k(feat)  # type: ignore[union-attr]
